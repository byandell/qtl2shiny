...
Recla,mouse,qtl2shinyData
```

The column names are fixed. The `project` is the project name, `taxa` has the taxa name, and `directory` is the relative or absolute address of the directory where data are kept. In this case, the basic structure of the app is:
...
file | contents
-----|------------------------------------------------
feather | directory with genotype probabilities created with [R/qtl2feather](https://github.com/byandell/qtl2feather)
