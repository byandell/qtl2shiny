...
[`Scan1Plot`](https://github.com/byandell/qtl2shiny/blob/master/R/shinyScan1Plot.R)| 210 | allele genome LOD and effect scans | plot, table
[`Mediate1Plot`](https://github.com/byandell/qtl2shiny/blob/master/R/shinyMediate1Plot.R)| 306 | mediation by other phenotypes | plot, table
[`ScatterPlot`](https://github.com/byandell/qtl2shiny/blob/master/R/shinyScatterPlot.R)| 149 | scatter plot for mediator | plot
 | | |
[`Probs36`](https://github.com/byandell/qtl2shiny/blob/master/R/shinyProbs36.R)| 93 | allele pair genotype probabilities |
...
[`Allele1`](https://github.com/byandell/qtl2shiny/blob/master/R/shinyAllele1.R)| 126 | allele and allele pair means | plot, tablt
 | | |
[`SNPAllele`](https://github.com/byandell/qtl2shiny/blob/master/R/shinySNPAllele.R)| 225 | manage SNP processng |
[`SNPProbs`](https://github.com/byandell/qtl2shiny/blob/master/R/shinySNPProbs.R)| 93 | SNP genotype probabilities |
[`SNPAssoc`](https://github.com/byandell/qtl2shiny/blob/master/R/shinySNPAssoc.R)| 102 | SNP association mapping | table
[`AllelePat`](https://github.com/byandell/qtl2shiny/blob/master/R/shinyAllelePat.R)| 276 | SNP allele patterns | plot, table
[`SNP`](https://github.com/byandell/qtl2shiny/blob/master/R/shinySNP.R)| 143 | create table of top SNPs | table
...
[`Scan1SNP`](https://github.com/byandell/qtl2shiny/blob/master/R/shinyScan1SNP.R)| 64 | plot SNP association | plot
[`TopFeature`](https://github.com/byandell/qtl2shiny/blob/master/R/shinyTopFeature.R)| 113 | top SNP features | plot, table
